...
pub fn get_timestamp(v: &str) -> Result<DateTime<Utc>, Error> {
...
impl<'a> ArgExt for clap::App<'a> {
    fn org_arg(self) -> clap::App<'a> {
        self.arg(
            clap::Arg::new("org")
                .value_name("ORG")
                .long("org")
                ...
                .about("The organization slug"),
        )
    }

    fn project_arg(self) -> clap::App<'a> {
        self.arg(
            clap::Arg::new("project")
                ...
                .about("The project slug"),
        )
    }

    fn projects_arg(self) -> clap::App<'a> {
        self.arg(
            clap::Arg::new("projects")
                ...
                .required(false)
                .validator(validate_project)
                .about("The project slug.  This can be supplied multiple times."),
        )
    }

    fn version_arg(self, index: u64) -> clap::App<'a> {
        self.setting(AppSettings::AllowLeadingHyphen).arg(
            clap::Arg::new("version")
                ...
                .about("The version of the release"),
        )
    }
}
