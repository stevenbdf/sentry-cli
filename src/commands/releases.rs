    ...
    app.about("Manage releases on Sentry.")
        ...
        .subcommand(App::new("new")
            ...
            .arg(Arg::new("url")
                .long("url")
                .value_name("URL")
                .about("Optional URL to the release for information purposes."))
            .arg(Arg::new("finalize")
                 .long("finalize")
                 .about("Immediately finalize the release. (sets it to released)")))
        ...
        .subcommand(App::new("set-commits")
            ...
            .arg(Arg::new("clear")
                 .long("clear")
                 .about("Clear all current commits from the release."))
            .arg(Arg::new("auto")
                .long("auto")
                .about("Enable completely automated commit management.{n}\
            ...
            .arg(Arg::new("local")
                ...
                .long("local")
                .about("Set commits of a release from local git.{n}\
                        This requires that the command is run from within a git repository.  \
                        sentry-cli will then automatically find remotely configured \
                        repositories and discover commits."))
            .arg(Arg::new("initial-depth")
                ...
                .about("Set the number of commits of the initial release. The default is 20."))
            .arg(Arg::new("commits")
                 .long("commit")
                 .short('c')
                 .value_name("SPEC")
                 .multiple(true)
                 .number_of_values(1)
                 .about("Defines a single commit for a repo as \
        ...
        .subcommand(App::new("finalize")
            ...
            .arg(Arg::new("started")
                 ...
                 .about("Set the release start date."))
            .arg(Arg::new("released")
                 .long("released")
                 .validator(validate_timestamp)
                 .value_name("TIMESTAMP")
                 .about("Set the release time. [defaults to the current time]")))
        .subcommand(App::new("list")
            .about("List the most recent releases.")
            .arg(Arg::new("no_abbrev")
                .long("no-abbrev")
                .hidden(true))
            .arg(Arg::new("show_projects")
                .short('P')
                .long("show-projects")
                .about("Display the Projects column")))
        .subcommand(App::new("info")
            ...
            .arg(Arg::new("quiet")
                .short('q')
                .long("quiet")
                .about("Do not print any output.{n}If this is passed the command can be \
        ...
        .subcommand(App::new("files")
            ...
            .subcommand(App::new("delete")
                ...
                .arg(Arg::new("all")
                    .short('A')
                    .long("all")
                    .about("Delete all files."))
                .arg(Arg::new("names")
                    .value_name("NAMES")
                    .index(1)
                    .multiple(true)
                    .about("Filenames to delete.")))
            .subcommand(App::new("upload")
                ...
                .arg(Arg::new("dist")
                    ...
                    .about("Optional distribution identifier for this file."))
                .arg(Arg::new("wait")
                    .long("wait")
                ...
                .arg(Arg::new("headers")
                    ...
                    .multiple(true)
                    .number_of_values(1)
                    .about("Store a header with this file."))
                .arg(Arg::new("path")
                    .value_name("PATH")
                    .index(1)
                    .required(true)
                    .about("The path to the file or directory to upload."))
                .arg(Arg::new("name")
                    .index(2)
                    .value_name("NAME")
                    .about("The name of the file on the server."))
                .arg(Arg::new("url_prefix")
                    .short('u')
                    .long("url-prefix")
                    .value_name("PREFIX")
                    .about("The URL prefix to prepend to all filenames."))
                .arg(Arg::new("url_suffix")
                    .long("url-suffix")
                    .value_name("SUFFIX")
                    .about("The URL suffix to append to all filenames."))
                .arg(Arg::new("ignore")
                    .long("ignore")
                    .short('i')
                    .value_name("IGNORE")
                    .multiple(true)
                    .about("Ignores all files and folders matching the given glob"))
                .arg(Arg::new("ignore_file")
                    .long("ignore-file")
                    .short('I')
                    .value_name("IGNORE_FILE")
                    .about("Ignore all files and folders specified in the given \
                ...
                .arg(Arg::new("extensions")
                    ...
                    .multiple(true)
                    .number_of_values(1)
                    .about("Set the file extensions that are considered for upload. \
            ...
            .subcommand(App::new("upload-sourcemaps")
                ...
                .arg(Arg::new("dist")
                    ...
                    .short('d')
                    .value_name("DISTRIBUTION")
                    .about("Optional distribution identifier for the sourcemaps."))
                .arg(Arg::new("validate")
                    .long("validate")
                    .about("Enable basic sourcemap validation."))
                .arg(Arg::new("wait")
                    .long("wait")
                    .about("Wait for the server to fully process uploaded files."))
                .arg(Arg::new("no_sourcemap_reference")
                    .long("no-sourcemap-reference")
                    .about("Disable emitting of automatic sourcemap references.{n}\
                ...
                .arg(Arg::new("no_rewrite")
                    .long("no-rewrite")
                    .about("Disables rewriting of matching sourcemaps. By default the tool \
                ...
                .arg(Arg::new("strip_prefix")
                    ...
                    .multiple(true)
                    .number_of_values(1)
                    .about("Strips the given prefix from all sources references inside the upload \
                ...
                .arg(Arg::new("strip_common_prefix")
                    ...
                    .about("Similar to --strip-prefix but strips the most common \
                ...
                .arg(Arg::new("bundle")
                    ...
                    .about("Path to the application bundle (indexed, file, or regular)"))
                .arg(Arg::new("bundle_sourcemap")
                    .long("bundle-sourcemap")
                    .value_name("BUNDLE_SOURCEMAP")
                    .conflicts_with("paths")
                    .requires_all(&["bundle"])
                    .about("Path to the bundle sourcemap"))
                // legacy parameter
                .arg(Arg::new("verbose")
                    .long("verbose")
                    .short('v')
                ...
                .arg(Arg::new("rewrite")
                    .long("rewrite")
                    .about("Enables rewriting of matching sourcemaps \
        ...
        .subcommand(App::new("deploys")
            ...
            .subcommand(App::new("new")
                ...
                .arg(Arg::new("env")
                     ...
                     .value_name("ENV")
                     .required(true)
                     .about("Set the environment for this release.{n}This argument is required.  \
                            Values that make sense here would be 'production' or 'staging'."))
                .arg(Arg::new("name")
                     .long("name")
                     .short('n')
                     .value_name("NAME")
                     .about("Optional human readable name for this deployment."))
                .arg(Arg::new("url")
                     .long("url")
                     .short('u')
                     .value_name("URL")
                     .about("Optional URL that points to the deployment."))
                .arg(Arg::new("started")
                     .long("started")
                     .value_name("TIMESTAMP")
                     .validator(validate_timestamp)
                     .about("Optional unix timestamp when the deployment started."))
                .arg(Arg::new("finished")
                     .long("finished")
                     .value_name("TIMESTAMP")
                     .validator(validate_timestamp)
                     .about("Optional unix timestamp when the deployment finished."))
                .arg(Arg::new("time")
                     .long("time")
                     .short('t')
                     .value_name("SECONDS")
                     .validator(validate_int)
                     .about("Optional deployment duration in seconds.{n}\
...
fn execute_new(ctx: &ReleaseContext, matches: &ArgMatches) -> Result<(), Error> {
...
fn execute_finalize(ctx: &ReleaseContext, matches: &ArgMatches) -> Result<(), Error> {
...
fn execute_set_commits(ctx: &ReleaseContext, matches: &ArgMatches) -> Result<(), Error> {
...
fn execute_delete(ctx: &ReleaseContext, matches: &ArgMatches) -> Result<(), Error> {
    let version = matches.value_of("version").unwrap();
...
fn execute_archive(ctx: &ReleaseContext, matches: &ArgMatches) -> Result<(), Error> {
    let version = matches.value_of("version").unwrap();
    let info_rv = ctx.api.update_release(
        ctx.get_org()?,
        version,
...
fn execute_restore(ctx: &ReleaseContext, matches: &ArgMatches) -> Result<(), Error> {
    let version = matches.value_of("version").unwrap();
    let info_rv = ctx.api.update_release(
        ctx.get_org()?,
        version,
...
fn execute_list(ctx: &ReleaseContext, matches: &ArgMatches) -> Result<(), Error> {
    let project = ctx.get_project_default().ok();
...
fn execute_info(ctx: &ReleaseContext, matches: &ArgMatches) -> Result<(), Error> {
    let version = matches.value_of("version").unwrap();
    let org = ctx.get_org()?;
    let project = ctx.get_project_default().ok();
...
fn execute_files(ctx: &ReleaseContext, matches: &ArgMatches) -> Result<(), Error> {
...
fn execute_deploys(ctx: &ReleaseContext, matches: &ArgMatches) -> Result<(), Error> {
    let release = matches.value_of("version").unwrap();
